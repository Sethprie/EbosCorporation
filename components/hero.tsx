    ...
    <section className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden noise">
      ...
      <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
        ...
        <motion.h1
          ...
          className="text-6xl sm:text-7xl md:text-8xl font-bold tracking-tighter mb-2"
        >
        ...
        <motion.p
          ...
          className="text-xl sm:text-2xl text-secondary font-mono mb-6"
        >
        ...
        >
          {["Artista Visual", "Diseñador", "Director", "VFX"].map((role, index) => (
            <span
              key={role}
              className={`px-4 py-2 border text-sm font-mono uppercase tracking-wider ${
